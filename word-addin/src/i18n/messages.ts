...
export const messages = {
  sv: {
    ...
    tokenPersistFailed: "Token används nu, men Word kunde inte spara den till nästa gång.",
  ...
  en: {
    ...
    tokenPersistFailed: "The token is in use now, but Word could not store it for next time.",

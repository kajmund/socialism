...
describe("inferExpertgranskningReportId", () => {
  it("returns the newest report when no panel job is known", () => {
    const reports = [report("rpt_old", "2026-09-01T10:00:00Z"), report("rpt_new", "2026-09-02T10:00:00Z")]
  ...
  it("ignores reports from before the current panel run", () => {
    const reports = [report("rpt_old", "2026-09-01T10:00:00Z"), report("rpt_new", "2026-09-03T12:00:00Z")]
    const job = panelJob({
      id: "job_rerun",

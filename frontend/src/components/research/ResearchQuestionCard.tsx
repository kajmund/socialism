...
function NeedAssessment({ assessment, sources }: { assessment: NonNullable<ResearchOverviewQuestion["need_assessment"]>; sources: ResearchOverviewQuestion["sources"] }) {
  const { t } = useLocale()

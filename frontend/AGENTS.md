...
- Language switcher lives in `AdminShell` (admin chrome). First migrated surface: nav + Jobs page + job toasts.
...
Out of scope for the first slice: simulator wizard, persona composer, run results, backend report HTML / OASIS prompts.

            ...
            def evidence(need: str, relation: str):
                legal = LegalResearchResult(
                    ...
                    case_law=CaseLawAnalysis(
                        ...
                        authoritative_holding={"court_level": "supreme", "text_role": "majority_reasons",
                            "outcome": "Villkoret jämkades", "adjustment_granted": True, "decision_basis": "statutory_adjustment",
                            "citations": [{"source_uri": uri, "quote": "jämkade ansvarsbegränsningen"}]},

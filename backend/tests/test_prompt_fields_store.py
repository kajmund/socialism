...
def test_modules_for_prompt_key_follows_prefix_convention():
    ...
    assert modules_for_prompt_key("research.lagen_nu.select.system") == [
        "dd",
        "politik",
        "expertgranskning",
    ]
    assert modules_for_prompt_key("research.lagen_nu.excerpt.user") == [
        "dd",
        "politik",
        "expertgranskning",
    ]
...
def test_module_providers_cover_all_catalog_keys_without_overlap_gaps():
    ...
    assert "panel.expert.competency" in dd_keys
    ...
    assert "panel.moderator.research_plan_repair" in expert_keys
    assert "panel.moderator.research_plan_repair" in dd_keys
    ...
    assert "expertgranskning.word.actor_context.known" in expert_keys
    assert "expertgranskning.word.actor_context.unknown" in expert_keys

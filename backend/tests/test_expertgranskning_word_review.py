...
def test_word_alembic_chain_is_linear_after_main_head():
    ...
    assert script.get_heads() == ["112_llm_configurations"]
    assert script.get_revision("112_llm_configurations").down_revision == "111_raw_domain_claims"
    ...
    document_knowledge = script.get_revision("102_document_knowledge")
    assert document_knowledge.down_revision == "101_expert_knowledge_receipts"
    ...
    assert claims.down_revision == "090_knowledge_questions"
    questions = script.get_revision("090_knowledge_questions")
    assert questions.down_revision == "089_evidence_quality"
    quality = script.get_revision("089_evidence_quality")
    assert quality.down_revision == "088_research_completeness"
    completeness = script.get_revision("088_research_completeness")
    assert completeness.down_revision == "087_research_objective_planner"
    ...
    assert loop.down_revision == "083_research_assessments"
    assessment = script.get_revision("083_research_assessments")
    assert assessment.down_revision == "082_research_need_executions"

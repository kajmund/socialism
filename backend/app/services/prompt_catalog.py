...
- Avoid repeating politicians' or news slogans verbatim — react in your own words.""",
    ...
    _f(
        ...
        (
            ...
            "Bakgrund:\n{brief}\n\n"
            "Din öppning:\n{opening}\n\n"
            "Expertförslag (slot_id inom hakparentes är expertens id — bevara requested_by):\n"
            "{expert_proposals}\n\n"
            ...
            "Tre varianter av samma fråga ska bli ett behov.\n"
            "- Bevara substantiella skillnader.\n"
            "- Gör frågorna konkreta och researchbara.\n"
            "- Bevara requested_by med experternas slot_id.\n"
            ...
            "- Sätt inga permanenta id:n."
        ),
        (
            "Topic: {topic}\n\n"
            "Background:\n{brief}\n\n"
            "Your opening:\n{opening}\n\n"
            "Expert proposals (the slot_id in brackets is the expert id — keep requested_by):\n"
            "{expert_proposals}\n\n"
            ...
            "Three variants of the same question must become one need.\n"
            "- Preserve substantive differences.\n"
            "- Make the questions concrete and researchable.\n"
            "- Keep requested_by with the experts' slot_id values.\n"

...
Description is 1–2 sentences. Return exactly {count} candidates.""",
    ...
    _f(
        ...
        (
            ...
            "- short_comment är texten i Word-marginalen: 1–3 hela meningar. "
            "Säg vad som är problemet och, när det är relevant, vad användaren bör "
            "överväga. Skriv färdiga meningar. Klipp inte av mitt i en mening. "
            ...
            "- Om en granskningsavsikt finns i systemmeddelandet: använd den när du "
            "bedömer materiality, actionability och should_materialize, inklusive "
            "partsställning. "
            "Granskande part är okänd om avsikten inte anger partsställning. "
            "Använd dokumentets partsbeteckningar. "
        ...
        (
            ...
            "- short_comment is the Word margin text: 1-3 complete sentences. "
            "State the issue and, where appropriate, the action the user should consider. "
            ...
            "- If a review intent is present in the system message: use it when judging "
            "materiality, actionability, and should_materialize, including party position. "
            "The reviewing party is unknown if the intent does not state a party. "
            "Use the document's party labels. "

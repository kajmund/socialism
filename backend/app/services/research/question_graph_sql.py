...
from app.database.models import KnowledgeQuestionEvidenceLink, KnowledgeQuestionRow
...
class SqlQuestionEvidenceGraph:
    ...
    async def lookup_answers(
        ...
        *,
        ...
        query = select(KnowledgeQuestionEvidenceLink).where(
            KnowledgeQuestionEvidenceLink.question_id == question.id
        )

...
class ResearchRuntimeNeed(Base):
    ...
    question_key: Mapped[str] = mapped_column(String(64), nullable=False)
    generated_from_need_id: Mapped[str | None] = mapped_column(String(64), nullable=True)
    original_need_id: Mapped[str | None] = mapped_column(String(64), nullable=True)
...
class LlmConfiguration(Base):
    """Named chat-LLM preset. Exactly one row is the process default."""

    __tablename__ = "llm_configurations"
    __table_args__ = (UniqueConstraint("name", name="uq_llm_configurations_name"),)
    ...
    prompt_fields: Mapped[list["PromptField"]] = relationship(

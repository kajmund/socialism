"""Add separate case facts and question relevance prompts.

Revision ID: 120_case_facts_relation
Revises: 119_court_analysis
"""
...
revision: str = "120_case_facts_relation"
down_revision: str | Sequence[str] | None = "119_court_analysis"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_NEW_KEYS = tuple(f"research.lagen_nu.{stage}.{role}" for stage in ("case_facts", "case_relation") for role in ("system", "user"))

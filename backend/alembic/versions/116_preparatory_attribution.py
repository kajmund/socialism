"""Add source attribution rules for preparatory-work interpretation.

Revision ID: 116_preparatory_attribution
Revises: 115_legal_passage_queries
"""
...
revision: str = "116_preparatory_attribution"
down_revision: str | Sequence[str] | None = "115_legal_passage_queries"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_NEW_KEYS = ("research.lagen_nu.domain.v3.preparatory_attribution", "research.lagen_nu.domain.v3.preparatory_role")
...
def downgrade() -> None:
    ...
    for key in _NEW_KEYS:
        ...
        if field_id is None:
            continue
        conn.execute(
            sa.text("DELETE FROM prompt_overrides WHERE prompt_field_id = :id").bindparams(id=field_id[0])
        )

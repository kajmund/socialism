"""Add generic_panel competency-only prompt.

Revision ID: 063_panel_competency_state
Revises: 062_panel_competency_gating
"""
...
revision: str = "063_panel_competency_state"
down_revision: Union[str, Sequence[str], None] = "062_panel_competency_gating"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_NEW_KEY = "panel.expert.competency"

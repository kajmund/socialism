"""Add focused passage search prompts for truncated legal documents.

Revision ID: 115_legal_passage_queries
...
revision: str = "115_legal_passage_queries"
down_revision: str | Sequence[str] | None = "114_legal_question_validation"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_NEW_KEYS = ("research.lagen_nu.passage_queries.system", "research.lagen_nu.passage_queries.user")

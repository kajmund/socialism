"""Add grounded pre-full-text relevance triage prompt.

Revision ID: 118_selection_triage
Revises: 117_case_citation_intent
"""
...
revision: str = "118_selection_triage"
down_revision: str | Sequence[str] | None = "117_case_citation_intent"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_NEW_KEYS = ("research.lagen_nu.select.triage",)

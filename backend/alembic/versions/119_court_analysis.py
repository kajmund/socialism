"""Add isolated deciding-majority analysis prompt.

Revision ID: 119_court_analysis
Revises: 118_selection_triage
"""
...
revision: str = "119_court_analysis"
down_revision: str | Sequence[str] | None = "118_selection_triage"
branch_labels: str | Sequence[str] | None = None
depends_on: str | Sequence[str] | None = None

_NEW_KEYS = ("research.lagen_nu.domain.v3.court_analysis", "research.lagen_nu.domain.v3.court_passage_v2")

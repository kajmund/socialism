"""Add Word intent-interview prompt field.

Revision ID: 071_intent_interview
Revises: 070_review_intent
"""
...
revision: str = "071_intent_interview"
down_revision: Union[str, Sequence[str], None] = "070_review_intent"
branch_labels: Union[str, Sequence[str], None] = None
depends_on: Union[str, Sequence[str], None] = None

_NEW_KEY = "expertgranskning.word.intent_interview"

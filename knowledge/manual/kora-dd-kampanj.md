...
En **DD-kampanj** samlar en sökbrief, kandidatbolag och körningar. Du chattar fram bolag i en modal och väljer vilka som ska ligga i kampanjen. Varje kandidat har en egen körning, likadant som i politikmodulen: resultat, konfiguration och ta bort.

## Skapa kampanjen

1. Öppna **Kampanjer** i menyn.
2. Välj **Starta ny DD-kampanj**.

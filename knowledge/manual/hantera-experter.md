...
8. **Föreslå experter** öppnar en ruta där du väljer underlag på samma sätt som i **Expertgranskning** — skapa mappar, dra filer mellan mappar, ladda upp eller välj en fil, förhandsgranska PDF och ta bort filer. Text och neutral dokumentkunskap tas fram i bakgrunden redan när filen laddas upp. Modellen föreslår profiler. Alla är ikryssade från början. Bocka ur dem du inte vill ha och klicka **Lägg till**. De sparas i expertbiblioteket.

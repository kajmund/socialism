...
8. **Föreslå experter** öppnar en ruta där du väljer underlag på samma sätt som i **Expertgranskning** — skapa mappar, dra filer mellan mappar, ladda upp eller välj en fil, förhandsgranska PDF (texten läses när förslaget körs) och ta bort filer. Modellen föreslår profiler. Alla är ikryssade från början. Bocka ur dem du inte vill ha och klicka **Lägg till**. De sparas i expertbiblioteket.

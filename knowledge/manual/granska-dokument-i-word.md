...
5. Klicka **Granska**. Tillägget läser dokumentet en gång och tar fram några korta frågor utifrån just den texten — samma frågor oavsett om det är ett avtal, ett CV eller en utredning. Svara genom att klicka. Passar inget av alternativen: välj **Annat / Inget av ovanstående** och skriv ditt svar. **Granska** syns i frågeformuläret men blir aktiv först när alla obligatoriska frågor är besvarade. Du kan gå tillbaka och ändra.

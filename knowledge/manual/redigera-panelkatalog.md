...
Här redigerar du **sub-frågor** (bedömningsdimensioner) och **default-expertprofiler** per modul. Ändringar gäller nästa panelkörning. Pågående eller avslutade körningar ändras inte.
...
5. Under **Default-expertprofiler**: redigera namn, beskrivning, bakgrund och ordning och klicka **Spara**. Ordningen måste vara unik. Avmarkera **Aktiv** för att sluta seeda den profilen.

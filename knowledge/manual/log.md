...
* **LLM**: Under **Verktyg** → **LLM** skapar du namngivna konfigurationer (modell, temperatur, top P, max tokens, reasoning). En av dem är default. Under **Konfigurationer** kan du per prompt välja en annan konfiguration; nya prompter använder default.
...
* **Expertgranskning i Word**: Du kan granska hela dokumentet eller den aktuella markeringen. Markering gäller hela stycken. Experterna får fortfarande hela dokumentet som underlag, men förslag skapas bara för de valda styckena.

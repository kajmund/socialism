...
I adminytan finns en **Hjälp**-knapp nere till höger på **alla sidor**. Där kan du chatta med en assistent som förklarar hur appen fungerar — utifrån användarmanualen och skrivskyddad live-data (t.ex. antal körningar, tonetiketter i aktiv konfiguration eller det du har öppet just nu). Assistenten använder prompttexterna för den organisation du är inloggad som: **administratör** och **användare** ser Opinionssimulators hjälp, **bolag** ser bolagsorganisationens.

## Öppna chatten

1. Klicka på **?**-knappen nere till höger (flytande, alltid synlig).

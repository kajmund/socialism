...
2. Medan simuleringen **körs** visas **Live-flöde** överst på Resultat: senaste händelsen först, med namn från populationen. Gillade inlägg och kommentarer är ihopfällda — klicka på ordet **inlägg** eller **kommentar** för att läsa texten och se gilla, ogilla och dela. Nya kommentarer säger vems inlägg de svarar på. Följ-händelser visar namnet på den som följdes. Du kan också följa jobbet under **Bakgrundsjobb**.
...
5. I översikten:
   ...
   - **Flöde** visar inlägg, kommentarer och reaktioner. Klicka på en agent för personaprofilen, eller **Intervjua** för att chatta om vad den sett. På klara körningar: stjärnan visar SSR-klassificering, skölden lägger till kommentaren som ankare.
6. Markera minst två försök och välj **Jämför markerade** för att beställa en jämförelserapport. Radiosymbolen till vänster om dokumentikonet öppnar det sparade live-flödet. Dokumentikonet beställer rapport för ett enskilt försök.
